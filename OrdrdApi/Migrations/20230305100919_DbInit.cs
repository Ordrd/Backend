        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthUserId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOrderingActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OptionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsMultiselectEnabled = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ItemId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderOptions_Options_OptionId",
                        column: x => x.OptionId,
                        principalTable: "Options",
                        principalColumn: "OptionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderOptions_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "OrderItemId");
                    table.ForeignKey(
                        name: "FK_OrderOptions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderChoiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    ChoiceId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderChoices", x => x.OrderChoiceId);
                    table.ForeignKey(
                        name: "FK_OrderChoices_Choices_ChoiceId",
                        column: x => x.ChoiceId,
                        principalTable: "Choices",
                        principalColumn: "ChoiceId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderChoices_OrderOptions_OrderOptionId",
                        column: x => x.OrderOptionId,
                        principalTable: "OrderOptions",
                        principalColumn: "OrderOptionId");
                    table.ForeignKey(
                        name: "FK_OrderChoices_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderChoices_ChoiceId",
                table: "OrderChoices",
                column: "ChoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderChoices_OrderOptionId",
                table: "OrderChoices",
                column: "OrderOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderChoices_UserId",
                table: "OrderChoices",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderOptions_OptionId",
                table: "OrderOptions",
                column: "OptionId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderOptions_OrderItemId",
                table: "OrderOptions",
                column: "OrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderOptions_UserId",
                table: "OrderOptions",
                column: "UserId");
